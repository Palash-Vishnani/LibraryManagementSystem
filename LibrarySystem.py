...
PalashLibrary=Library(["Harry Potter","Goosebumps","Bhagwat Gita","Ramayana","Perfume: Story Of a Murderer"],"Palash")
...
print("Welcome to Palash's Library")
while True:
    print(d1)
